...
class Card extends Component {
    ...
    render() {
        ...
        <div style={{backgroundColor:"#1b2838",height:200, borderRadius:10,padding:10, margin:10,boxShadow: "0px 0px 15px rgba(0,0,0,0.15)"}} key="key1" onClick={()=>this.props.modal()} onDoubleClick={()=>this.openfile(file.Path)}>
